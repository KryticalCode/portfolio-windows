  ...
  return (
    <div className="flex flex-col space-y-8">
      ...
      <section>
        ...
        <div className="flex flex-row flex-wrap gap-4 mt-4 bg-gray-100 p-4 rounded-lg shadow-md">
          <a
        ...
        <div className="flex flex-row flex-wrap gap-4 mt-4 bg-gray-100 p-4 rounded-lg shadow-md">
          ...
          >
            <img
              ...
              className="w-80 h-50 object-cover rounded-lg shadow-md"
            />
            <span className="text-center">To-Do List App</span>
          </a>
          <a
          ...
          >
            <img
              ...
              className="w-80 h-50 object-cover rounded-lg shadow-md"
            />
            <span className="text-center">(This) Portfolio Website</span>
          </a>
          <a
          ...
          >
            ...
            />
            <span className="text-center">
              Full Stack C# Library Management System
            </span>
          </a>
          <a
            href="https://github.com/KryticalCode"
          ...
          >
            <img
              ...
              className="w-80 h-50 object-cover rounded-lg shadow-md"
            />
            <span className="text-center">PROJECT TO ADD</span>
          </a>
        </div>
      </section>
    </div>
